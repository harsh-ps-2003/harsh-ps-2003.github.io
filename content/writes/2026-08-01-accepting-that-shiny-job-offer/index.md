...
Okay, so finally I have accepted a full-time offer from an early stage startup. During my journey of talking to founders, HRs, giving 50ish interviews, I have realized a lot. Like a lot for a naive out of uni kid! Also, was helping bunch of folks to clear interviews, so have some third-party perspective as well. AI writing resumes, and AI ATS filtering resumes, what a joke! Ghosting is the new norm (even when HR reaches out to you). I have received lots of mails of people who have been reading the stuff I write and it helping them. So, I am writing this blog, according to 2026 reality. I hope the upcoming generation of engineering and researchers have it better than me ;(
...
Here is something that might surprise you. A recent study found that companies spending the most on AI are actually hiring more people, not fewer. The top third of AI adopters saw a 10.2 percent average increase in headcount after adoption. For entry level roles specifically, it was 12 percent. Companies with low AI adoption saw basically no change.

In my experience talking to founders and interviewing at AI first companies, this tracks. They are genuinely more open to hiring early grads than traditional companies. The reasoning is simple. If you are building with AI from day one, you want people who grew up with these tools, not people who need to unlearn 15 years of habits. A new grad who has been prompting models since freshman year is more valuable than a senior engineer who still thinks of AI as a fancy autocomplete.

But there is a catch nobody talks about. These AI first companies work you into the ground. The pace is relentless. Ship fast, iterate faster, burn through problems at a rate that would make a traditional company's head spin. I have talked to friends at AI startups who describe it as exhilarating for the first six months and exhausting by month nine. The burnout rate is real. When every engineer is expected to do the work of three because AI is supposed to multiply their output, the pressure compounds. You are not just competing with other engineers. You are competing with the theoretical version of yourself that the founders imagined when they said AI would 10x productivity.

The tradeoff is stark. Traditional companies are not hiring new grads at all. AI first companies are hiring them, but burning them out fast. Neither option is great. But at least with the AI first path, you are building skills that will matter in five years. The traditional path might be more sustainable, but good luck finding a traditional company that will take a chance on you right now.

But there is a darker story underneath. A [Stanford study](https://digitaleconomy.stanford.edu/publications/canaries-in-the-coal-mine/) using ADP payroll data found that workers aged 22 to 25 in AI exposed occupations experienced a 16 percent relative employment decline. Software developers in that age group are down nearly 20 percent from late 2022. Meanwhile, workers aged 35 to 49 in the same occupations grew by over 8 percent.

The theory is that AI substitutes for codified knowledge, the book learning you get in school. It struggles more with tacit knowledge, the tips and tricks that accumulate with experience but never get written down. Young workers have more of the former, less of the latter. That makes them easier to replace.

One more finding that matters. Employment declined where AI automates work, but grew where AI augments it. The distinction determines whether AI is your competitor or your tool.

Karpathy built a [US Job Market Visualizer](https://karpathy.ai/jobs/) scoring 342 occupations by AI exposure. Software developers score 9 out of 10. But a high score does not mean the job disappears. Demand could grow as each developer becomes more productive. The takeaway is not that software engineering is dying. It is being reshaped faster than almost any other profession. If you are not adapting, you are falling behind. If you are adapting, you are becoming more valuable than ever.
...
The career ladder is flattening from the middle. Google cut 35 percent of managers of small teams. Coinbase flattened to 5 layers below the CEO. Middle management is the layer being removed. Leadership stays. ICs stay. The middle gets squeezed out. If you are aiming for management, there are fewer rungs. If you are staying IC, the path is clearer. Companies need people who do the work more than people who measure it.
...
This is creating what I call a barbell effect. On one end, a concentrated group of top performers are being paid extremely well to take on scope that previously required much larger teams. On the other end, many capable engineers are struggling to find roles at all, or to find a role that meaningfully exceeds their current compensation. The middle has thinned out. Average no longer clears the bar.

The bifurcation is stark. AI and ML engineers see job posting growth of 163 percent year over year. Generalist engineers see 8 to 15 percent. AI engineers command a 56 percent wage premium according to PwC. The average total comp for AI specialists at mid senior level is 206K versus 165K for generalists. At the top end, AI roles at frontier companies can hit 1M plus while generalist roles cap around 450K. Two completely different markets exist under the same job title.

I talked to an AI engineer at a decacorn in San Francisco who said it is the greatest job market he has ever seen. The inbound top of the funnel is bonkers, and he finds himself saying no to places he would have once killed to work at. Meanwhile, a software engineer with 6 years of experience in London told me that as a developer without a specific specialization, he is struggling to get any interviews. He spent a few years as frontend, then another few as backend, and most recently working on DevEx. In this market, he just does not get any callbacks for interviews, not even a first round.

You can see this shift clearly in how companies are redesigning incentives. Meta recently updated their performance system to allow top performers to earn bonuses worth up to 300 percent of their target. Google has made similar moves by increasing rewards for top ratings while compressing outcomes for the middle. Same level. Same role. Dramatically different outcomes based purely on impact.

Let me break down how these systems actually work. Meta's new Checkpoint system has four tiers. Outstanding, which is about 20 percent of employees, gets a 200 percent bonus multiplier. Excellent, which is about 70 percent, gets 115 percent. Needs Improvement at 7 percent gets 50 percent. Not Meeting Expectations at 3 percent gets zero. And then there is the Meta Award, a 300 percent multiplier for a small number delivering truly exceptional impact. Two review cycles per year with bonuses paid twice annually. Equity refreshers based on the average of both ratings.

Google is doing something similar with their GRAD system. They are expanding the distribution guidance for Outstanding Impact rating so more employees can achieve it. To fund this, they are slightly reducing bonus and equity multipliers for Significant Impact and Moderate Impact ratings. It is budget neutral. They are rewarding top performers by reallocating from the middle tier.

Amazon's Overall Value system rewards sustained excellence over single year achievements. Four consecutive years of Top Tier gets you 110 percent of pay band, which exceeds the previous 100 percent cap. Three consecutive years gets 105 percent. But here is the catch. First time Top Tier only gets 70 percent, down from 80 percent. First time HV3 gets 40 percent, down from 50 percent. The message is clear. One good year does not cut it anymore. You have to prove yourself repeatedly.

The rise of PIPs as silent layoffs is part of this. PIPs logged against 43.6 out of every 1000 US workers in 2023, a nearly 30 percent increase from 2020. Microsoft's January 2025 cuts were structured around performance based terminations without severance. Some managers are held to explicit PIP quotas, a required share of their team that must be on a plan regardless of actual performance. Even if their entire team is high performing, a percentage of employees have to be placed on a PIP. Meta instructed managers on large teams to place 15 to 20 percent in the lowest tier, up from 12 to 15 percent. They explicitly framed the mid year review as an opportunity to make exit decisions.

Equity is reinforcing the same message. Front loaded vesting schedules went mainstream in 2025. About 24 percent of new hire equity grants at public companies now use front weighted vesting, up from near zero a few years ago. Nvidia, Oracle, and DoorDash use 40/30/20/10 schedules. Google uses 33/33/22/12 with monthly vesting and no cliff. Amazon is the opposite with 5/15/40/40, which is why they use sign on bonuses to compensate for the back loaded structure.

Here is the catch with front loaded vesting that nobody tells you. A front loaded grant is 37.5 percent less equity in your offer letter for the same target total comp. Year 3 and 4 compensation drops significantly without strong refreshers. The companies are betting that you will earn your way to refreshers. If you do not, your comp falls off a cliff. You must verify refresher policies before accepting because they are now the primary engine for long term pay.

Restructurings are narrowing focus onto fewer, higher leverage initiatives. Engineering managers at major tech companies now supervise about 12 engineers, up from 10 in 2019. At startups, it is about 15 engineers per manager, a 34 percent increase. Product managers now support 22 percent more engineers than in 2019. Software engineers now account for 55 percent of all hiring at major tech companies, up from 46 percent in 2019. The org is flattening and concentrating around the people who do the work.
...
The compensation reflects the leverage. At Palantir, which originated the role, Staff level FDEs earn 486K to 630K. At frontier labs like OpenAI and Anthropic, Staff level FDEs earn around 610K and Principal level can hit 1M to 1.2M. The entire gap between Palantir and frontier labs sits in equity, which is now 55 to 70 percent of comp at the top of market, up from 35 to 45 percent in 2024. That is forcing companies to grapple with a hard truth. Percentiles are no longer universal across departments. The 90th percentile for AI or forward deployed work can exist alongside the 60th to 70th percentile elsewhere, inside the same company, without it being a mistake.

Layer on top of that the quiet golden handcuffs effect from the last few years. Many senior engineers who joined during the 2021 to 2022 window are sitting on massively appreciated equity and simply cannot be matched by today's market unless the role is AI critical. An Nvidia employee's 488K grant from 2023 is now worth over 2.2M. A Broadcom employee's 66K grant from 2023 is now worth about 265K. Some employees have unvested RSUs valued at 6x their salary.

The trap is that refresh grants reset the handcuff clock. Accepting new 4 year grants means the handcuffs never fully release. And the after tax value of 400K in unvested RSUs is only about 190K at a 52 to 53 percent combined tax rate. When you negotiate with a new employer, present your exact vesting schedule, not a total dollar amount. Ask for a mix of cash sign on to cover near term loss and new RSUs to replace long term equity. Know the new employer's cliff structure because a 1 year cliff creates a compensation gap.
...
The tech sector, which built its global dominance on hiring smart 22 year olds and betting on their trajectory, has retired that playbook. Top CS grads in 2025 are twice as likely to call themselves a founder compared to the 2022 class, and 45 percent less likely to land a job at a major tech company. Whatever comes next will be built largely by the generation that managed to cross the threshold before the door slammed shut.
...
### The remote work tax nobody talks about
...
## The equity game nobody tells you about

When I was comparing offers, I kept making the same mistake. I would look at the total comp number and think that was the whole story. 400K versus 350K, easy choice right? But the more I dug into it, the more I realized the mix matters as much as the total.

![Companies buy top of market pay with equity not salary](equity-vs-total-comp.png)

Here is something I wish someone had told me earlier. If you want to predict which companies pay the best, do not look at their salary bands. Look at how much of the package is stock. The relationship is surprisingly tight. Companies that pay mostly in cash cluster together in a narrow range. Companies that pay mostly in equity are the ones hitting the crazy numbers you see on compensation threads.
...
Think about the companies known for paying the most. OpenAI, Databricks, Figma, Airbnb. They did not get there by offering 300K base salaries. They got there by offering 60 percent of the package as stock. OpenAI reportedly structures packages where equity is more than double the base salary. Databricks runs recurring tender offers so employees can actually get liquidity on their private stock. These companies figured out that if you want to pay at the 99th percentile, you do it with equity.

![How tech pays senior engineers](senior-engineer-comp-breakdown.png)

Look at how different companies structure senior engineer pay. Databricks at 640K average total comp with 62 percent equity. OpenAI at 651K with 58 percent equity. Netflix is the outlier at 595K but 100 percent cash and zero equity. Microsoft at 296K with only 19 percent equity. The pattern is clear. The highest paying companies are the ones loading up on stock. Netflix proves you can pay well with all cash, but they are the exception. Most companies that want to compete at the top do it by giving you a piece of the company.
...
The companies stuck in the bottom left of that chart, traditional enterprises and defense contractors, are not there because they are cheap. They are there because they cannot credibly offer equity that anyone would value. A 0.01 percent stake in a company with no growth story is worth nothing in the minds of candidates. So they compete on base salary, which puts them in a narrow band, which means they can never reach the total comp numbers that equity heavy companies can.

This creates a sorting mechanism. The engineers who understand equity and believe in a company's trajectory will take the equity heavy offer. The engineers who need cash now or do not trust the equity story will take the higher base offer. Neither is wrong. But over a career, the equity heavy path has historically been where the outlier outcomes come from. Early Google employees, early Facebook employees, early Stripe employees. They did not get rich on salary. They got rich because they took equity in companies that 10x'd or 100x'd.

The dark side is that most equity becomes worthless. Most startups fail. Liquidation preferences mean common shareholders often get nothing even in an acquisition. Dilution from future funding rounds can cut your ownership in half or worse. The 90 day exercise window after leaving means you might have to write a check for tens of thousands of dollars in taxes just to keep your options. And if the company never goes public or gets acquired, your equity is just paper.

The numbers are brutal if you look at them honestly. One analysis of 847 equity packages found that 97.3 percent of employee stock options are worthless. The career math says if you work at 10 startups over a 40 year career, there is a 60.5 percent chance you will never see a meaningful payout. The average startup employee sacrifices 400K in salary over 4 years for stock options worth zero. That is not pessimism. That is the base rate.

And even when companies do well, the 409A discount means your equity is worth less than you think. When a company raises at a 100M valuation, your options are not priced at that valuation. They are priced at the 409A fair market value of common stock, which is typically 25 to 60 percent lower than the preferred stock price. A company that just raised at 10 dollars per share might have a 409A of 1.50 per share. You think you are getting 100K in equity. The company is giving away shares worth 15K on paper.

If you are in the UK, the tax situation is actually much better. The Enterprise Management Incentive scheme is one of the most generous equity tax regimes in the world. With EMI options, you pay no income tax and no National Insurance when you exercise, as long as the exercise price was at or above market value when the options were granted. When you sell, the gain is taxed as capital gains, not income. And if you hold for two years, you can get Business Asset Disposal Relief which drops the rate to 10 percent instead of 20 percent. Compare that to the US where exercising ISOs can trigger AMT on paper gains you have not realized, and where the spread on NSOs is taxed as ordinary income at up to 37 percent plus state taxes.

The UK government expanded EMI significantly in April 2026. Companies can now have up to 500 employees and 120 million pounds in gross assets, up from 250 employees and 30 million. The exercise period was extended from 10 years to 15 years. Individual employees can hold options worth up to 250K over any three year period. For early stage startups in the UK, EMI is basically free money compared to the tax treatment you would get in the US. The company also gets corporation tax relief on the difference between market value and exercise price. It is genuinely one of the best things about working at a UK startup.
...
For me, joining Sqwish AI in the UK meant taking the equity bet. I took a pay cut compared to my Indian offers. The EMI scheme makes the tax situation much better than it would be in the US. But I am still betting that the company will be worth something in a few years. That is a conscious choice I made. I wanted to be somewhere early stage where I could have real impact, and equity was part of that trade off. Just make sure you understand what trade off you are actually making.
...
The role is Research Scientist. A few years back, almost nobody outside of academia knew what this job was. Now every AI company is fighting over these people like they are the last engineers on earth.
...
I think about it this way. A software engineer ships the app. A research scientist invents the thing that makes the app possible. They are the ones designing new architectures, figuring out why training is unstable, running experiments that take weeks to complete. Most of them have PhDs. Their job is to create capabilities that did not exist before, then hand those capabilities to the engineers who productionize them.
...
But something interesting happened recently. The job hopper premium is vanishing. In 2022, during the Great Resignation, switchers were seeing nearly 18 percent more wage growth than people who stayed put. By early 2026, that gap collapsed to almost nothing. In some industries, stayers actually outperformed hoppers. The math that made job hopping a no brainer for a decade is quietly breaking down.

This got me thinking about the people who never played that game at all. The engineers who spent 10, 20, 30 years at a single company. Some of them have been at their company longer than the median age of their coworkers. In an industry where two years feels like a long time, these people are outliers.

![Where tech's 10 year lifers work and what they earn](ten-year-lifers.png)
...
But here is what fascinates me. There is a software engineer who has spent 35 years at NASA's Jet Propulsion Laboratory in Pasadena. One of a small group of JPL engineers who simply never left. Still writing code that controls spacecraft. There are people like this scattered everywhere the spotlight does not reach. Decades long careers on aerospace factory floors, at government labs, at universities and small town employers. People who found something worth staying for and never looked back.

I read about a 30 year Microsoft veteran who said he never had to think about money as a factor in life. He just brought his genuine self to work and everything followed. A 20 year Google engineer talked about always looking for seemingly impossible problems and awesome people to work with, and finding both without needing to look anywhere else. These are not people who stayed because they were stuck. They stayed because they found what they were looking for.

There is also something job hoppers rarely acknowledge. You can learn the basics of a codebase in year one. You become competent. In year two, you start understanding why things were built the way they were. But real expertise, the kind where you can anticipate problems before they happen and shape the direction of a product, that takes year three and beyond. I have talked to senior engineers who say they can tell within 30 minutes whether someone has surface level knowledge or genuine depth. Job hoppers often have breadth without depth. They know a bit about many things but have not truly mastered anything. That intuition, that judgment, it gets built over years of staying and going deep.

I am not saying everyone should stay forever. Strategic movement still pays, especially early in your career when you are building skills and finding your niche. But somewhere along the way, for some people, the calculus changes. The next rung on the ladder matters less than the work itself. The JPL engineer writing code that leaves the planet probably does not care that a Google engineer makes three times more. They are doing something that matters to them in a way that no salary can replace.
...
![Experience vs Level vs Compensation](experience-vs-compensation.png)

This chart changed how I think about career progression. Look at the rising stars zone. Engineers with just 5 to 7 years of experience hitting 700K to 900K at Staff and Principal levels. Then look at the overlap zone. A Senior engineer with 15 years of experience earning less than a Staff engineer with 5. Same industry, same job family, wildly different outcomes.

![Base salary growth for SWEs at top tech companies](base-salary-growth-yoe.png)

But base salary tells a different story. Look at how the lines converge. At year zero, there is a 15K spread between the highest and lowest paying company. Amazon starts at 131K, Apple at 148K. By year 10, the spread has widened to about 40K but the trajectories are remarkably similar. All five companies follow nearly the same curve. The real divergence happens after year 15 where Meta pulls ahead to 260K while Microsoft and Amazon flatten around 230K.
...
Years of experience can be a useful proxy in aggregate. More time usually means more scope, more projects, more reps. But it is not prescriptive. The rising stars often joined hypergrowth companies early, made big bets on hard problems, or optimized for trajectory over comfort. The late bloomers might have spent years in slower moving industries, taken non linear paths, or prioritized factors beyond compensation.

The trend line tells the final story. Compensation flattens after about 10 years of experience. After that, level is what moves the needle, not tenure. You can have 20 years of experience and earn less than someone with 7 if they made Staff and you stayed Senior. The market does not pay for time served. It pays for scope and impact.

Here is the structural reality that nobody tells you. 85 to 90 percent of engineers plateau at Senior. Not from lack of ability, but from limited Staff positions, different skills required, and work many engineers simply do not want to do. Senior is terminal at most companies. You can stay there indefinitely with satisfactory performance. Staff roles are scarce. Senior engineer submissions outnumber staff submissions roughly 3 to 1 on compensation sites.

The Senior to Staff jump is the largest single compensation increase after you hit Senior. At some companies it is 30 to 50 percent. At Pinterest it is 82 percent, from 399K to 727K. At Stripe it adds 310K. But the jump requires fundamentally different work. A senior engineer is paid to deliver. A staff engineer is paid to make other people's delivery better. That is a different skill that does not automatically arrive with more years of shipping features.
...
If someday you think you want to do a startup, then join one sometime in your career. I see a lot of very good eng leaders doing their own company, as its easier than before now. They have core team in US, raise funds there, and often hire in India.

This fundamentally is an old way of looking at things. Startups are not as bad as people think of them. Yeah, ESOP are paper money, I am not disagreeing there. But there are things beyond money in careers that compound better. As an engineer, you are the culmination of hardest problems you have tackled in your career. 

![Startup base salaries are rising fast](startup-base-salary-rise.png)

But here is the thing that has changed. The old startup deal was straightforward. Take a lower base salary, bet on equity, hope for an IPO. That tradeoff made sense when startups could not compete on cash. Now they can. Median base salary offers for software engineers at venture backed startups have jumped from 160K to 200K since 2022. That is a 25 percent increase in just a few years. Total comp including equity is up 18 percent over the same window.

The driving force is a collision of massive VC funding and an extremely thin talent pool at the top. Recruiters say the top 5 to 10 percent of candidates are the ones commanding all the offers while everyone else struggles. It is a candidate's market at the top and an employer's market at the bottom. These startups are staying lean, so every hire needs to be exceptional, and exceptional people have leverage.

The numbers tell the story. General software engineer listings are down 49 percent from the 2022 peak. Machine learning and AI engineer listings are up 59 percent. AI specialists get 3 to 5 competing offers and close in 17 days. Everyone else struggles to get an interview. 85,000 tech workers have been laid off in 2026 so far, and at the same time 61 percent of companies plan to increase headcount. Layoffs and hiring surges happening simultaneously in the same industry. It is two completely different economies sharing the same job board.

Here is something wild. Junior AI professionals in North America averaged 173K total compensation in 2025. That exceeds director level averages of 152K at some organizations. A new grad at Jane Street makes 380K. A senior engineer at Lockheed Martin makes 134K. Entry level at Jane Street out earns seniors at Microsoft, Cisco, and Intel. The inversion reflects the premium on hands on AI deployment skills over management experience. If you have the right skills, seniority does not matter as much as it used to.

The WSJ reported on a math competition winner with only 9 months of professional experience who was offered a 400K base salary for a software engineering role. Not total comp. Just base. CS grads with 1 to 2 years of experience are pulling 250K to 300K base offers at startups. These are the extreme top of the market, but they show what is possible when you have the right signals. Competition wins, published research, open source contributions. The median junior AI engineer still earns 120K to 170K base. But the ceiling has blown off for the exceptional ones.

The funding numbers explain why. Global venture funding hit a record 510 billion dollars in the first half of 2026. OpenAI and Anthropic alone captured 217 billion, which is 43 percent of all startup funding. 86 cents of every VC dollar went to AI companies. When that much money is chasing that few people, compensation goes insane. OpenAI's average stock based compensation reached 1.5 million per employee. Meta offered sign on packages exceeding 100 million for elite AI researchers. Google DeepMind responded with golden handcuff equity refreshers of 500K to 1.2 million for senior researchers.

The equity model is evolving too. Tender offers have become standard at most late stage private companies, giving employees liquidity years before an IPO. Some startups have eliminated vesting cliffs entirely, meaning employees own shares from day one. The whole take a pay cut and pray for an exit model is becoming outdated. Now you can get competitive cash and still have upside. Over 60 percent of tech candidates now rank base salary as their top compensation priority, up from about 45 percent in 2022. Equity grants remain about 26 percent lower than pre 2022 levels. The startup offer letter of 2026 finally looks less like a lottery ticket and more like a real financial instrument.
...
![AI engineers now earn up to 60 percent more](ai-engineer-premium.png)

The numbers back this up. At the same title and same level, AI and ML engineers earn 11 to 60 percent more than everyone else. At L1, the gap is 11 percent. By L5, it is 60 percent. A senior AI engineer at 725K versus a senior non-AI engineer at 453K. Same ladder, same company, same title. The gap widens at every level. If you are not building AI experience right now, you are leaving money on the table and falling behind people who are.
...
Choosing the right company is very important now, and its extremely hard as well. Its time to accelerate. We don't know what the next 6 months will look like, and I cant even imagine the next decade. Its a quantum leap that humans are going to make with AI.
